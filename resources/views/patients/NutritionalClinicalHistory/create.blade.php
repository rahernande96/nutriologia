				...
				<form action="{{ route('NutritionalClinicalHistory.store', $patient->slug) }}" method="POST">
					...
					<div class="row">
						...
						<div class="col-md-2 d-flex align-items-center justify-content-center">
							<label for="oilseed_allergy" class="allegry mb-3">Oleaginosas</label>	
						</div>
						<div class="form-group col-md-10">
							<input type="text" class="form-control allegry" id="oilseed_allergy" placeholder="Detalles de la alergia." value="{{ old('oilseed_allergy') }}" name="oilseed_allergy">
						</div>
						...
						<div class="form-group col-md-10">
							<input type="text" class="form-control allegry" id="fruit_allergy" placeholder="Detalles de la alergia." value="{{ old('fruit_allergy') }}" name="fruit_allergy">
						</div>
						...
						<div class="form-group col-md-10">
							<input type="text" class="form-control allegry" id="vegetable_allergy" placeholder="Detalles de la alergia." value="{{ old('vegetable_allergy') }}" name="vegetable_allergy">
						</div>
						...
						<div class="form-group col-md-10">
							<input type="text" class="form-control allegry" id="AOA_allergy" placeholder="Detalles de la alergia." value="{{ old('AOA_allergy') }}" name="AOA_allergy">
						</div>
