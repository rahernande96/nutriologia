                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 offset-md-2">
                            {!! Form::model($basicMeasure,['route'=> ['anthropometry.basicMeasureUpdate', $basicMeasure->id],'method'=>'PUT','class'=>'form'])!!}
    ...
    gestation_week.keyup(function(){
        if(gestation_week.val() != '' && pregestational_weight.val() !='')
        {
            ...
            else
            {
                ...
                dataJson.imc = $('input[name="imc"]').val();
