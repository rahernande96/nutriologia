                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active p-4" id="rapid" role="tabpanel" aria-labelledby="home-tab">
                                    <form action="{{ route('reminder.store') }}" method="POST">
                                        @csrf
                                        @include('patients.Reminder.fields_rapid')
                                    </form>
                                </div>
                ...
                <form action="" id="form-modal-new-food">
                    ...
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                                <label for="food_modal_protein">Proteínas:</label>
                                <input type="number" name="protein" min="0" class="form-control" id="food_modal_protein" placeholder="Proteínas" required>
                        </div>
                        <div class="col-md-4 mb-3">
                                <label for="food_modal_lipids">Lípidos:</label>
                                <input type="number" name="lipids" min="0" class="form-control" id="food_modal_lipids" placeholder="Lípidos" required>
                        </div>
                        <div class="col-md-4 mb-3">
                    ...
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
                                <label for="food_modal_energy">Energía:</label>
                                <input type="number" name="energy" min="0" class="form-control" id="food_modal_energy" placeholder="Energía" required>
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="form-row">
                        <div class="col-md-3 mb-3">
                                <label for="food_modal_hierroNO">Hierro NO HEM:</label>
                                <input type="number" name="hierro_NO" min="0" class="form-control" id="food_modal_hierroNO" placeholder="Hierro NO HEM" required>
                        </div>
                        <div class="col-md-3 mb-3">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-4 mb-3">
                            <label for="food_modal_acidoA">Ácido Ascórbico:</label>
                            <input type="number" name="acido_ascorbico" min="0" class="form-control" id="food_modal_acidoA" placeholder="Ácido Ascórbico" required>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="food_modal_acidoF">Acido Fólico:</label>
                            <input type="number" name="acido_folico" min="0" class="form-control" id="food_modal_acidoF" placeholder="Ácido Fólico" required>
                        </div>
                    </div>
...
<script>
    ...
    $("body").on('change', '.food-check-detail', function() {
        ...
        if( $(this).is(':checked') ) {
            ...
            $('.content-food-details').find('.content-food').each(function(){
