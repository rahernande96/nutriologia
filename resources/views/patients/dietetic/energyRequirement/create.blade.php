    ...
    <div class="col-md-12">
        <div class="card mt-3 tab-card">
            ...
            <div class="tab-content" id="myTabContent">
                {!! Form::open(['route' => 'dietetic.getStore']) !!}
                @if($energy_requirement->type_get == 1)
...
<script>
    ...
    $('input[name="method_water_requirement"]').change(function(){
        ...
        var water_requirement = $('input[name="water_requirement"]');
        if($(this).val() == 3)
        {
            water_requirement.prop('readonly', false);
            water_requirement.removeClass('form-control-plaintext');
            water_requirement.addClass('form-control');
            water_requirement.prop('required',true);
        }
        else
        {
            water_requirement.prop('readonly', true);
            water_requirement.addClass('form-control-plaintext');
            water_requirement.removeClass('form-control');
            water_requirement.prop('required',false);
        }
    });
